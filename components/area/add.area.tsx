        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalFooter>
                <Button onPress={()=>{setBounds([]); setIsAdd(false); onClose}}>Close</Button>
                <Button color='danger' className='yellow' onPress={()=>{createRec(); setBounds([]); setIsAdd(false); onClose()}}>Add Area</Button>
              </ModalFooter>
            </>
          )}
        </ModalContent>
